    ...
    self.client.on('data', function(data){
        ...
        switch (self.mode) {
            ...
            case 8:
                ...
                if (self.BufferSize == self.info.width*self.info.height*4) {
                    //console.log(self.BufferSize);
                    //console.log(self.rect.width*self.rect.height*4+':'+self.BufferSize);
                    self.events.emit('encode');
                }
                if (self.BufferSize > self.info.width*self.info.height*4) {
                    //console.log(self.info.width*self.info.height*4+":"+self.BufferSize);
                    self.events.emit('encode');
                    var buf = Buffer.concat(self.BufList, self.BufList.totalLength);
                    //console.log(buf.slice(self.rect.width*self.rect.height*4));
                    self.FramebufferUpdateRequest(0,0,0,self.info.width,self.info.height);
                    //var fs = require('fs');
                    //fs.writeFileSync('buf.txt', buf.slice(self.rect.width*self.rect.height*4));
                   //
                }                
                break;
            case -1:
